...
func GenerateE2EDemoTests() {
	...
	configTest, _ := e2eConfig.LoadTestGeneratorConfig(configTestFile)

	for _, appTest := range configTest.Tests {

		framework.E2ESuiteDescribe(appTest.Name, Ordered, Label("e2e-demo"), func() {
			defer GinkgoRecover()
